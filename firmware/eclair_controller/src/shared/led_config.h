...
// Logical LED zones currently include the wired sculpture body zones Z1 through Z7.
const uint8_t LED_LOGICAL_ZONE_COUNT = 7;

// Default active animation window after an accepted ESP32 controller trigger.
const uint32_t LED_ACTIVE_WINDOW_MS = 10000;

const uint16_t LED_TOTAL_PIXEL_COUNT = 1908;
