...
constexpr uint8_t ECLAIR_Z1_LED_PIN = 4;
constexpr uint8_t ECLAIR_Z2_LED_PIN = 5;
constexpr uint8_t ECLAIR_Z3_LED_PIN = 6;
constexpr uint8_t ECLAIR_Z4_LED_PIN = 7;
constexpr uint8_t ECLAIR_Z5_LED_PIN = 8;
constexpr uint8_t ECLAIR_Z6_LED_PIN = 9;
constexpr uint8_t ECLAIR_Z7_LED_PIN = 10;
...
static void eclairRenderFrame(uint32_t nowMs) {
  ...
  for (uint16_t pixel = 0; pixel < LED_TOTAL_PIXEL_COUNT; pixel++) {
...
static void eclairRegisterLedControllers() {
  FastLED.addLeds<WS2812B, ECLAIR_Z1_LED_PIN, GRB>(eclairFrame + LED_ZONE_START[0], LED_ZONE_PIXEL_COUNT[0]);
  FastLED.addLeds<WS2812B, ECLAIR_Z2_LED_PIN, GRB>(eclairFrame + LED_ZONE_START[1], LED_ZONE_PIXEL_COUNT[1]);
  FastLED.addLeds<WS2812B, ECLAIR_Z3_LED_PIN, GRB>(eclairFrame + LED_ZONE_START[2], LED_ZONE_PIXEL_COUNT[2]);
...
void setup() {
  ...
  delay(500);
  Serial.println();
  Serial.println("Eclair seven-zone controller starting...");
  ...
  Serial.println("Eclair LED lanes Z1..Z7 GPIO4,5,6,7,8,9,10; pixels 208,325,400,300,300,300,75; GRB");
}
